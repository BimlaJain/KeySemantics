    ...
    return (
        <div className=' bg-royalblue'>
            <div className="container xl:py-24 md:py-16 lg:py-20 py-12 relative">
                <div className='absolute top-0 left-[3%] xl:block hidden pointer-events-none'>
                    <img src="./assets/images/webp/footer-icon1.webp" alt="footer-icon" />
                </div>
                <div className='absolute bottom-1 right-[3%] xl:block hidden pointer-events-none'>
                ...
                <div className="flex justify-center">
                    ...
                    >
                        {FORM_FIELDS_LIST.map((field) => (
                            <div key={field.id} className="mb-2 max-w-[320px] mx-auto">
                                <input id={field.id} type="text" placeholder={field.placeholder} required={field.required} value={formData[field.id]}
                                    ...
                                    className="w-full sm:py-4 py-3 pl-5 mx-auto text-white bg-blurblue placeholder-voilet rounded-full focus:outline-none"
                                />
                            </div>
                        ))}
                        ...
                        <CommonButton classList="hover:!bg-white hover:!text-skyblue !bg-skyblue !text-white  !py-3 !px-8 max-sm:!py-2 max-sm:!px-4 !mt-6 !mx-auto" NavButton=" Request a demo" />
                    </form>
                </div>
            </div>
        </div>
