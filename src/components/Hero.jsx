...
const Hero = () => {
    return (
        <div className='lg:min-h-screen 2xl:min-h-fit bg-cover bg-no-repeat bg-center max-lg:pb-20 max-sm:pb-10' style={{ backgroundImage: `url(./assets/images/png/hero-bg.png)` }}>
