    ...
    return (
        <div className='lg:min-h-screen 2xl:min-h-fit bg-cover bg-no-repeat bg-center max-lg:pb-20 max-sm:pb-10 2xl:pb-[287px] bg-pink' style={{ backgroundImage: `url(./assets/images/webp/hero-bg.webp)` }}>
            <div className="container">
                ...
                <CommonButton classList="!py-[17.2px] !px-[30.7px] max-sm:!py-2 max-sm:!px-4 !bg-royalblue !border !border-royalblue hover:!text-royalblue !text-white hover:!bg-white !text-base !mx-auto " NavButton="Get Started"/>
            </div>
        </div>
    )
}
